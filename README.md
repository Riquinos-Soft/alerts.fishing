...
<div align="center">
  <img src="docs/assets/brand/alerts-fishing-logo-concept.png" alt="Provisional visual concept for alerts.fishing" width="280">
  <p><em>Provisional visual concept — not the final identity.</em></p>
</div>
...
- [ ] Best fishing windows with clear condition explanations.
...
The source of truth is [docs/Home.md](docs/Home.md). It works on GitHub and as an Obsidian vault without required plugins.
